...
{    
    public static void main(String args[])
    {
        if(args.length < 3)    {
            ...
            RESTAPIThread service1=new RESTAPIThread("127.0.0.1", args[0], args[1], args[2]);
            RESTAPIThread service2=new RESTAPIThread("127.0.0.1", args[0], args[1], args[2]);
            RESTAPIThread service3=new RESTAPIThread("127.0.0.1", args[0], args[1], args[2]);
            service1.start();
            service2.start();
            service3.start();
        }
